            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="signUp">
                        ...
                        <div class="form-group">
                            <button id="btn1" type="submit" class="btn btn-primary btn-lg btn-block login-button">Sign up</button>
                        </div>
                        <div class="login-signup">
                            <button onclick="location.href='login'" type="button" class="btn btn-primary btn-lg btn-block login-button" style="background-color:green">Sign in</button>
                        </div>
                    </form>
                </div>
            </div>
